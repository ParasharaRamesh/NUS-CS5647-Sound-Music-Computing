...
def main():
    ...
    '''
    prepare_data function takes in the ground truth and the predictions on the test set (i.e. songs #91 -> #95) and stores in the following lists:
    id_list -> list of song ids
    pred -> list of predictions annotations for each song id
    gt -> list of ground truth annotations for each song id
    '''
